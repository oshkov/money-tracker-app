function getAccounts() {
    ...
    fetch(`http://${ip}:8003/get-accounts`, {
        method: 'GET',
        headers: {
...
function getCategories() {
    ...
    fetch(`http://${ip}:8003/get-categories`, {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${token}`
        }
...
function getOperations() {
    ...
    fetch(`http://${ip}:8003/get-operations`, {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${token}`
        }
...
function createAccount(jsonData) {
    // Создание счета
    return fetch(`http://${ip}:8003/create-account`, {
        method: 'POST',
        headers: {
...
function editAccount(jsonData) {
    ...
    return fetch(`http://${ip}:8003/edit-account`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
function deleteAccount(jsonData) {
    // Удаление счета
    return fetch(`http://${ip}:8003/delete-account`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
function createCategory(jsonData) {
    // Создание категории
    return fetch(`http://${ip}:8003/create-category`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
function editCategory(jsonData) {
    ...
    return fetch(`http://${ip}:8003/edit-category`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
function deleteCategory(jsonData) {
    // Удаление счета
    return fetch(`http://${ip}:8003/delete-category`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
...
function createOperation(jsonData) {
    // Создание категории
    return fetch(`http://${ip}:8003/create-operation`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
